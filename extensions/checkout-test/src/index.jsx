...
export function App({ extensionPoint, storage }) {
  ...
  return (
      ...
      >
          <View>
          <Image source="https://media.istockphoto.com/photos/police-officer-picture-id157394322?s=612x612" />
          </View>
          <View />
          ...
          <TextContainer>
              ...
              <TextBlock>
              This is a test to see we can create a post purchase extension for anything we want
              </TextBlock>
          </TextContainer>
          <Button>This button does nothing guys</Button>
          </BlockStack>
      </Layout>
      </BlockStack>
  );
